...
public class AuslesenMehrereCSVFile {
    ...
    public static List<Object[]> readTestDataFromCsv(String csvFilePath) throws IOException, MeineException {
        ...
        try (BufferedReader reader = Files.newBufferedReader(Paths.get(csvFilePath))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (tokens.length == 11) {
                    ...
                    throw new MeineException(FehlerTyp.UNGUELTIGE_ZEILE, "Ungültige Zeile (falsche Spaltenzahl):");
                }
            }
        }
        return testData;
