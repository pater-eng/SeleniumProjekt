...
public class TestForm1ParameterizedSeleniumKursFireFox {
	...
	public TestForm1ParameterizedSeleniumKursFireFox(String testName, String username, String password, String betreff,
	...
	public static Collection<Object[]> provideTestData() throws Exception {
		...
		Object[][] daten = {
				{ "Test Form 1 Test 1 FireFox", "selenium102", "codingsolo", "Parametrisierter Test 1", "Dieter",
						"Java Grundlagen Kurs mit Dieter", new int[] { 2, 4, 6 }, new int[] { 2 },
						"Java Grundlagen Kurs", "Magazzini Alimentari Riuniti" },
				{ "Test Form 1 Test 2 FireFox", "selenium102", "codingsolo", "Parametrisierter Test 2", "Miriam",
