...
public class TestForm1ParameterizedSeleniumKursFireFox {
	...
	public static Collection<Object[]> provideTestData() throws Exception {
		...
		Object[][] daten = {
				{ "Test Form 1 Test 1 FireFox", "firefox", "selenium102", "codingsolo", "Parametrisierter Test 1",
						"Dieter", "Java Grundlagen Kurs mit Dieter", new int[] { 2, 4, 6 }, new int[] { 2 },
						"Java Grundlagen Kurs", "Magazzini Alimentari Riuniti" },
				{ "Test Form 1 Test 2 Chrome", "chrome", "selenium102", "codingsolo", "Parametrisierter Test 2",
						"Miriam", "Java Grundlagen Kurs mit Dieter", new int[] { 2, 4, 6 }, new int[] { 2 },
						"Java Grundlagen Kurs", "Magazzini Alimentari Riuniti" },
				{ "Test Form 1 Test 3 IE", "ie", "selenium102", "codingsolo", "Parametrisierter Test 2",
						"Miriam", "Python Grundlagen Kurs mit Dieter", new int[] { 2, 4, 6 }, new int[] { 2 },
