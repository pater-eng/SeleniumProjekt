...
public class SeleniumKatzenSuchenPage {
	...
	public String srcLinkImgKatze2Auslesen() {
		if (imgKatze2.isDisplayed() && imgKatze2.isEnabled()) {
			...
			System.out.println("IMAGE2 ist NICHT sichtbar!!!!!");
			return "IMAGE2 ist NICHT sichtbar!";
		}
	}
	...
	public String srcLinkImgKatze3Auslesen() {
		if (imgKatze3.isDisplayed() && imgKatze3.isEnabled()) {
			...
			System.out.println("IMAGE3 ist NICHT sichtbar!!!!!");
			return "IMAGE3 ist NICHT sichtbar!";
		}
	}
