...
public class TestLogingLokatorenDragAndDrop2 {
	...
	public void test() {
		...
		// Element verschieben in definiereter Position. Ziehe das Element um 250 Pixel nach rechts und 0 Pixel nach unten
		action.dragAndDropBy(redElement, 250, 0).build().perform();
		// Maustaste auf dem Quell-Element drücken und halten
		action.clickAndHold(greeElement).perform();
		// Element zu einem Ziel bewegen
