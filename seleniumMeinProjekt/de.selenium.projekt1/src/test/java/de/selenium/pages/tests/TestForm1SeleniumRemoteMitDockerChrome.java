...
public class TestForm1SeleniumRemoteMitDockerChrome {
...
//	private WebElement linkMenuSeleniumApp;
	...
	public void setUp() throws Exception {
		...
		/*
		 * Verbindung über den Docker(Docker Hub und Node müssen jeweils einen nach dem Anderem gestartet werden.)
		 */
